  ...
  *)
        ...
        match res1 with
          ...
          | BoolVal true -> 
                  ...
                  match res2 with
                        ...
                        | _ -> reportWrongType "right operand of &&" Int res2 (expPos e2)
  ...
  | Not(e, pos) ->
        ...
        match res with
          ...
          | _ -> reportWrongType "right operand of 'not'" Bool res (expPos e)
        
  | Negate(e, pos) ->
        let res   = evalExp(e, vtab, ftab)
        match res with
          | IntVal n -> IntVal -n
          | _ -> reportWrongType "right operand of ~" Int res (expPos e)
